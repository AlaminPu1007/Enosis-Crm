    ...
    return(
      ...
      {/*Start Modal Open Live Accounts */}
          <View style={{flex:1,}}>
            ...
            <TouchableOpacity 
            style={{flex:1,justifyContent:'center',backgroundColor:'#ddd'}}
            ...
            <View style={styles.modelView}>
              ...
              <View style={[styles.buttonView,
              	{borderRadius:25,width:'60%',position:'absolute',top:-25,zIndex:1,borderRadius:30}]}>
	              	<Text 
	              	style={styles.openLiveButtonText}>
	              	Open New Ticket
	              	</Text>
              </View>

              <View style={styles.ModalInputView}>
              <View style={{width:'90%',paddingVertical:50}}>
              ...
              <View style={styles.ButtonViewStyle}>
              	...
              	<View style={styles.BUTTON}> 
              		<Text style={[styles.openLiveButtonText,
              			{color:'#fff',paddingVertical:10}]}>Deposit</Text>
              	</View>
              	</TouchableOpacity>
              	</View>
              	...
              	>
              	<View style={[styles.BUTTON,
              		{backgroundColor:'#ed5a5a',paddingHorizontal:'10%',}]}> 
              		<Text style={[styles.openLiveButtonText,
              			{color:'#fff',paddingVertical:10}]}>Close</Text>
              	</View>
              	</TouchableOpacity>
              	</View>
