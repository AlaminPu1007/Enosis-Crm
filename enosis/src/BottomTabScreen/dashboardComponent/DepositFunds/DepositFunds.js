        ...
        <View style={styles.myLiveDetailsView}>
          {/*start myLiveBOx here*/}
            ...
            <View>
             ...
             <View>
              ...
              <View style={styles.bankTransfer}>
                <Text style={styles.bankTransferText}>BANK TRANSFERS </Text>
              </View>
               {
                currentPosts.map(item=>{
                  return(
           ...
           <View>
              ...
              <View style={styles.bankTransfer}>
                <Text style={styles.bankTransferText}>E-WALLETS </Text>
              </View>

               <View style={styles.EwalletsView}>
                <Text style={styles.eWalletsText}>E-WALLETS</Text>
                <Entypo name="emoji-sad" size={30} color='yellow'
                  style={{paddingHorizontal:5}}
                />
                <Text style={styles.eWalletsText}>No Options</Text>
               </View>
